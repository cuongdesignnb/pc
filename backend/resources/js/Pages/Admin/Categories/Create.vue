...
const form = useForm({ name: '', slug: '', parent_id: '', component_type_id: '', description: '', image: '', icon: '', sort_order: 0, is_active: true, show_on_pc_website: true, meta_title: '', meta_description: '', technical_heading: 'auto' });
